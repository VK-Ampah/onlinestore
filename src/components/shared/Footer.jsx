...
const Footer = () => {
  ...
  return (
      ...
      //     </div>
      //   </div>
      <footer className=" flex justify-between p-10 bg-base-300 text-base-content bg-slate-800">
        <div>

          <nav className="flex flex-col">
            <header className="text-xl font-bold mb-2">Services</header> 
        ...
        <div>
          <nav className= "flex flex-col">
            <header className="text-xl font-bold mb-2">Company</header> 
        ...
        <div>
          <nav className= "flex flex-col">
            <header className="text-xl font-bold mb-2">Social</header> 
